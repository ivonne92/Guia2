...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    private RadioButton Cambia;

    public Descargar(Context context, TextView lblEstado,Button btnDescargar, ProgressBar progressBar,RadioButton cambia) {
